...
ggplot(df_avg, aes(y=female_vs_male, x=treatment)) + 
  geom_boxplot() +
  ...
  theme_minimal() +
  xlab("treatment") +
  ylab("female -> male aggressive events")
...
ggplot(df_avg, aes(y=female_vs_female, x=treatment)) + 
  ...
  theme_minimal()+
  xlab("treatment") +
  ylab("female -> female aggressive events")
...
ggplot(df_avg, aes(y=large_vs_large, x=treatment)) + 
  ...
  theme_minimal() +
  xlab("treatment") +
  ylab("large -> large aggressive events")
