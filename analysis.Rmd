...
```{r}
files <- list.files("/Users/lukereding/Documents/common_garden/data/nov", pattern = "*.json", full.names = T)
...
df_avg %>%
  ...
  scale_color_ptol() + 
  geom_smooth(se = F, color = "#75b5aa") +
  # scale_fill_brewer(palette = "Dark2", guide= F) +
  ylab("total_courtship") +
  xlab("number_focal") +
  ggtitle("total courtship vs. number of focal fish id'ed") +
  theme_clean()
...
df_avg %>%
  ...
  geom_smooth(se = F, color = "#75b5aa") +
  # scale_fill_brewer(palette = "Dark2", guide= F) +
  xlab("number_small_male") +
  ylab("total courtship") +
  ggtitle("total courtship vs. number of large males id'ed") +
  theme_clean()

df_avg %>%
  filter(treatment %in% c("LS", "LL")) %>% 
  ggplot(aes(number_model_female, total_courtship)) +
  geom_point(aes(color = treatment)) +
  scale_color_ptol() + 
  geom_smooth(se = F, method = lm,color = "#75b5aa") +
  # scale_fill_brewer(palette = "Dark2", guide= F) +
  xlab("number_model_female") +
  ylab("total courtship") +
  ggtitle("total courtship vs. number of large males id'ed") +
  theme_clean()
...
df_avg %>%
  ...
  # scale_fill_brewer(palette = "Dark2", guide= F) +
  ylab("total_courtship") +
  xlab("total_aggression") +
  ggtitle("total courtship vs. total_aggression") +
  theme_clean()
...
df_avg %>%
  ...
  geom_smooth(se = F, color = "#75b5aa") +
  # scale_fill_brewer(palette = "Dark2", guide= F) +
  ylab("number_small_male") +
  xlab("number_focal") +
  ggtitle("# small males vs. # of focal dish id'ed") +
  theme_clean()
...
df_avg %>%
  ...
  # scale_fill_brewer(palette = "Dark2", guide= F) +
  ylab("number_large_male") +
  xlab("number_focal") +
  ggtitle("# large males vs. # of focal dish id'ed") +
  theme_clean()
...
df_avg %>%
  ...
  ylab("total_males") +
  xlab("number_focal") +
  ggtitle("# males vs. # of focal dish id'ed") +
  theme_clean()
...
df_avg %>%
  ...
  ylab("total_males") +
  xlab("number_models") +
  ggtitle("# males vs. # of models dish id'ed") +
  theme_clean()
```
...
df_avg %>%
  ...
  scale_fill_ptol(guide = F) +
  ylab("# aggressions") +
  ggtitle("average number of aggressions per video") +
  theme_clean()+
...
df_avg %>%
  ...
  geom_jitter(width=0.2, size=2.4, height=0) + 
  scale_fill_ptol(guide= F) +
...
limits <- aes(ymax = avg_court + se_court, ymin=avg_court - se_court)
  courts <- df_avg %>%
    ...
    geom_bar(aes(fill=treatment), stat = "identity") +
    # geom_jitter(width=0.3, height=0.15, aes(size = aggresion_towards_females)) +
    scale_fill_manual(values=cols[c(4,5,2,7)], guide=F) + 
    # scale_size(name = "chases towards\nfemales") + 
    ylab("average # courtships per video") +
    # ggtitle("number of courtship events per video") +
    theme_mod() +
    # ylim(c(0,2)) +
    scale_x_discrete(breaks=c("LS","SS","LL", "FF"),
          labels=c("large and small males", "only small males", "only large males", "only females")) +
  ...
  cosersion <- df_avg %>%
    ...
    scale_fill_manual(values=cols[c(4,5,2,7)], guide=F) + 
    # scale_size(name = "chases towards\nfemales") + 
    ylab("average # coersion attempts per video") +
    # ggtitle("number of courtship events per video") +
    theme_mod() +
    scale_x_discrete(breaks=c("LS","SS","LL", "FF"),
          labels=c("large and small males", "only small males", "only large males", "only females")) +
