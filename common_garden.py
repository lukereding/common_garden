...
if __name__ == "__main__":
    ...
    # if veiwing on a small screen, double the values of the points to keep things consistent
    if size == "small":
    ...
    'tank_id' : tank_id,
    'pairwise_distance_males' : pairwise_distance(male_locations) if male_locations is not None else None,
    'pairwise_distance_females' : pairwise_distance(model_female_locations) if model_female_locations is not None else None,
    'pairewise_distance_juvs' : pairwise_distance(focal_female_locations) if focal_female_locations is not None else None,
